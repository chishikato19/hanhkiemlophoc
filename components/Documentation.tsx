        ...
        {activeSubTab === 'guide' && (
            <div className="prose max-w-none text-gray-700">
                ...
                <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200 text-sm mb-4">
                    <strong>Lưu ý quan trọng:</strong> Để tính năng "Học sinh báo cáo từ xa" hoạt động, bạn <strong>BẮT BUỘC</strong> phải cập nhật đoạn mã bên dưới vào Google Apps Script và Deploy lại.
                </div>
...
{`function doGet(e) {
  return ContentService.createTextOutput("Smart Classroom API v2 is running.");
}
            ...
            <div className="max-w-3xl">
                ...
                <div className="relative border-l-2 border-indigo-200 ml-3 space-y-8 pl-6 py-2">
                    ...
                    <div className="relative">
                        ...
                        <h4 className="font-bold text-lg text-gray-800">Phiên bản 2.0 (Mới nhất)</h4>
